...
p_black_black <- 2/4   # the card with two black sides (BB)
p_black_white <- 1/4   # the card with one black and one white side (BW)
p_white_white <- 1/4   # the card with two white sides (WW)
